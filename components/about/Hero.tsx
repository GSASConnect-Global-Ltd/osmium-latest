    ...
    <div className="min-h-screen bg-background font-santoshi">
      ...
      <section className="relative flex flex-col items-center min-h-screen px-8 py-20 md:px-16 lg:px-24">
        ...
        <div className="relative z-10 mt-32 md:mt-40 lg:mt-48">
          <p
            className="mx-auto ppEditorial font-thin text-[72px] leading-[86px] tracking-[0.04em] text-center bg-gradient-to-r from-[#EBFAF2] to-[#FFFFFF] bg-clip-text text-transparent"
            style={{ width: "666px" }}
          >
        ...
        {/* Small Info */}
          <div className="relative z-10 w-full mt-[119px] mb-[314px] max-w-7xl">
